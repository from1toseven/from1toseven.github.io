...
//I added a fullscreen button to the video. Through my observation of friends and myself, we all prefer to have a bigger screen 
//while consuming visual media like watch movies, Youtube etc so it became my first choice of button. 
//The audio is easily adjusted on any devices hence it was not my priority.
//The loop functions is also considered. However, my insight is whenever people put looping a video it would be for long-time listening through
//a working/study session, so  they usually don't pay attention in the visual material.
//Hence, I think the full-screen button is the most important functions for a video-based website, serving the purpose of displaying visual contents.
